...
const DriverLogin = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1510596713412-56030de252c8?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')"
      }}
    >
      {/* Glassmorphism container */}
      <div className="bg-white/7 backdrop-blur-md p-8 rounded-2xl shadow-lg max-w-md w-full mx-auto">
        {/* Logo / Heading */}
